...
{
    [Entity(TableCnName = "接口控制关联",TableName = "InterfaceToRelationships")]
    public partial class InterfaceToRelationships:BaseEntity
    {
        /// <summary>
       ///
       /// </summary>
       ...
       ///
       /// </summary>
       [Display(Name ="InterfaceUid1")]
       [MaxLength(200)]
       [Column(TypeName="nvarchar(200)")]
       [Editable(true)]
       public string InterfaceUid1 { get; set; }
       ...
       ///
       /// </summary>
       [Display(Name ="InterfaceUid2")]
       [MaxLength(200)]
       [Column(TypeName="nvarchar(200)")]
       [Editable(true)]
       public string InterfaceUid2 { get; set; }
