...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormFields = ref({"UserName":"","UserTrueName":"","Role_Id":[],"DeptIds":"","Enable":"","Gender":"","Remark":"","HeadImageUrl":"","Subject":""});
            const editFormOptions = ref([[{"title":"帐号","required":true,"field":"UserName","disabled":true}],
                              ...
                              [{"dataKey":"subject","data":[],"title":"专业","field":"Subject","type":"select"}]]);
            ...
            const columns = ref([{field:'User_Id',title:'User_Id',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'Subject',title:'专业',type:'string',bind:{ key:'subject',data:[]},width:120,align:'left'},
